      ...
      <div class="row">
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            ...
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
          <p class="mb-0"><span class="text-success text-sm font-weight-bolder">Recemment Ajoute(e) : </span>{{ $recentlyAddedFormatLastName }} {{ $recentlyAddedFormatFirstName}} </p>
            </div>
          </div>
        </div>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="avatar-group mt-2">
                            ...
                            <h6 class="mb-0 text-sm">{{ $student->prenom }}</h6>
                          </div>
                        </td>
                          ...
                          <div class="progress-wrapper w-75 mx-auto">
                            <div class="progress-info">
                              <div class="progress-percentage">
                                <span class="text-xs font-weight-bold">{{$student->cycle}}</span>
                              </div>
                            </div>
                        ...
                        <td class="align-middle text-center text-sm">
                          <span class="text-xs font-weight-bold"> {{ $student->niveau }} </span>
                        </td>
                      </tr>
                    @endforeach
